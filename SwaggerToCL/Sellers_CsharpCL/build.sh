...
${nuget_cmd} install src/SellingPartnerAPI.SellerAPI/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/SellingPartnerAPI.SellerAPI.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/SellingPartnerAPI.SellerAPI.dll \
-recurse:'src/SellingPartnerAPI.SellerAPI/*.cs' \
-doc:bin/SellingPartnerAPI.SellerAPI.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/SellingPartnerAPI.SellerAPI.dll was created successfully"
fi
