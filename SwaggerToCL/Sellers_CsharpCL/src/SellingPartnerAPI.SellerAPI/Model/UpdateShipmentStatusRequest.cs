...
namespace SellingPartnerAPI.SellerAPI.Model
{
    ...
    public partial class UpdateShipmentStatusRequest :  IEquatable<UpdateShipmentStatusRequest>, IValidatableObject
    {
        ...
        public UpdateShipmentStatusRequest(MarketplaceId marketplaceId = default(MarketplaceId), ShipmentStatus shipmentStatus = default(ShipmentStatus), OrderItems orderItems = default(OrderItems))
        {
