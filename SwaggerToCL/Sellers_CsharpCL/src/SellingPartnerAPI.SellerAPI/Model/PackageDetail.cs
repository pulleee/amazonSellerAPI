...
namespace SellingPartnerAPI.SellerAPI.Model
{
    ...
    public partial class PackageDetail :  IEquatable<PackageDetail>, IValidatableObject
    {
        ...
        public PackageDetail(PackageReferenceId packageReferenceId = default(PackageReferenceId), string carrierCode = default(string), string carrierName = default(string), string shippingMethod = default(string), string trackingNumber = default(string), DateTime? shipDate = default(DateTime?), string shipFromSupplySourceId = default(string), ConfirmShipmentOrderItemsList orderItems = default(ConfirmShipmentOrderItemsList))
        {
        ...
        public PackageReferenceId PackageReferenceId { get; set; }
