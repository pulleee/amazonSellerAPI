...
namespace SellingPartnerAPI.SellerAPI.Model
{
    ...
    public partial class ConfirmShipmentRequest :  IEquatable<ConfirmShipmentRequest>, IValidatableObject
    {
        ...
        public ConfirmShipmentRequest(PackageDetail packageDetail = default(PackageDetail), CodCollectionMethodEnum? codCollectionMethod = default(CodCollectionMethodEnum?), MarketplaceId marketplaceId = default(MarketplaceId))
        {
