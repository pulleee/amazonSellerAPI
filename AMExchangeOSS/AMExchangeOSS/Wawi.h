...
class TBeleg : public TWawi
{
	...
	UnicodeString sFreiertext1, sFreiertext2;
	...
	bool copyBelegExtra(UnicodeString sQuellBelegtyp, UnicodeString sQuellBeleg, UnicodeString sZielBelegtyp, UnicodeString sZielBeleg);
	...
	void setVertreter(UnicodeString sVertreter) {this->sVertreter=sVertreter;}
 	void setFreiertext1(UnicodeString sFreiertext1) {this->sFreiertext1=sFreiertext1; _bHeaderChanged=true;}
	void setFreiertext2(UnicodeString sFreiertext2) {this->sFreiertext2=sFreiertext2; _bHeaderChanged=true;}
...
class TBelegp
{
  ...
  int iOSSVerfahren;
	...
	double getMEUmrechnung() {return(dMEUmrechnung);}
};
