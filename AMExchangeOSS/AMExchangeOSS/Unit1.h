...
__published:	// Von der IDE verwaltete Komponenten
	...
	TMenuItem *GetOrderListCanceled1;
	TCheckBox *cbxCheckStornosAuto;
	TAdvEdit *edAutoCheckStronosTime;
	TButton *btnAutoCheckStornos;
	TLabel *Label1;
	...
	void __fastcall GetOrderListCanceled1Click(TObject *Sender);
	void __fastcall btnAutoCheckStornosClick(TObject *Sender);
	void __fastcall cbxCheckStornosAutoClick(TObject *Sender);
...
public:		// Benutzer-Deklarationen
  ...
  void __fastcall doAMBestandBatchUpload(void);
	...
	void __fastcall doAMCheckStornos(void);
	...
	void __fastcall doAMPreisFeedUpload(void);
